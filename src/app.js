...
// ========== MEMBUAT ELEMENT TEXT BESERTA ARIBUT CLASS dan ID VERSI JS===========


// membuat element untuk isi root (child untuk parent)
const text = document.createElement('h1')
text.textContent = 'Hallo saya dipanggil dari JavaScript'

// menambah atribut class kepada element
text.className = 'heading'

// menambah atribut id kepada element
text.id = 'heading'

// masukan element text (child) ke dalam element root (parent)
root.appendChild(text)



// ========== MEMBUAT ELEMENT TEXT BESERTA ARIBUT CLASS dan ID VERSI REACT JS===========
...
// ========== MEMBUAT ELEMENT DENGAN JSX agar lebih mudah ===========
const listAngka = (
    <ul className="list Angka">
        <li id="uwwu">
            Saya Angka Pertama
        </li>
        <li>
...
// embed javascript expression kedalam JSX
// embed varibel
const reza = 'Reza'
const nama = <h2>Hallo Saya {reza}</h2>
...
const luasPersegi = <h3>Luas Persegi adalah {persegi(4, 5)}</h3>

// embed classname (props) kedalama JSX
const heading = 'heading-1'
const className = <h5 className={heading}>Ini adalah text h5</h5>

// embed gambar ke dalam JSX, diujung tag harus di tutup. Bukan > tapi />
...
const alt = 'gambar'
const gambar = <img src={link} alt={alt} />
...
// React component -> function di js yg diawali dengan huruf besar dan memilki nilai return berupa jsx
function Conunter() {
    // tetapkan nilai awal
    ...
    return (
        <>
            ...
            <span style={{ "margin": 10 }}>{state}</span>
